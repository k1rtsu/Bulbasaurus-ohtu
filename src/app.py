    ...
    if request.method == 'POST':
        try:
            ...
            if reference_type == "inproceedings":
                handle_add_inproceeding(request.form)
            elif reference_type == 'book':
                handle_add_book(request.form)
            elif reference_type == 'misc':
                handle_add_misc(request.form)
            elif reference_type == 'article':
                handle_add_article(request.form)
...
def handle_add_inproceeding(form):
